					...
					<div class="row">
					    @foreach($project->floors as $floor)
					        @if(array_key_exists('url', $floor['sheet']))
        						...
        						<div class="col-md-4">
        							<a download href="https://skyriseprojects.com/testapi/public/uploads/floor_sheet/{{ $floor['sheet']['url'] }}"><div class="border-img-new"><img src="https://skyriseprojects.com/testapi/public/uploads/floor_media/{{ $floor['images']['url'] }}"  style="height: 370px !important;" class="img-responsive"></div></a>
        						</div>
